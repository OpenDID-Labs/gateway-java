...
public class OracleMethodAccessValidator implements
    MethodAccessVerify {

  private Logger logger = LoggerFactory.getLogger(OracleMethodAccessValidator.class);


  @Override
  public void checkAccess(String traceId, Web2Method methodProcess, String method) {
    if (methodProcess.getClass().isAnnotationPresent(MethodOracle.class)) {
  ...
  public static OracleMethodAccessValidator getInstance() {
    return InstanceHolder.instance;
  }

  private static class InstanceHolder {

    private static final OracleMethodAccessValidator instance = new OracleMethodAccessValidator();
  }
}
